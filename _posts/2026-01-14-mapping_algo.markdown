...
|-:|
| <span style="font-size: 16px;"> It goes without saying that for complex graphs, such first-order biasing may not be nuanced enough. But as with many things in tech, it's more of a tradeoff between computer time and human time. A bit of thoughtful guidance goes a long way. </span> |
{:.about_table4}
