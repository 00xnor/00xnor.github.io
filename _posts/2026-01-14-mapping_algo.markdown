...
|:-|
| <span style="font-size: 16px;"> For workloads executing on distributed systems, performance is often limited by data movement rather than computation. As a result, efficient execution depends critically on how the workloads are partitioned and **placed across hardware resources**. </span> |
