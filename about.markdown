...
● | <span style="font-size: 16px;"> Formulated a nuanced approach for assessing accuracy of analog inference beyond standard evaluation metrics ([**description**]({% post_url 2026-02-14-analog_inference %})). </span> |
...
|:-|
● | <span style="font-size: 16px;"> **Graph Compiler for a Weight-Stationary Dataflow** <br> JEDEC Mobile/Client/AI Computing Forum <br> 🇺🇸 San Jose, CA, May 2024 </span> |
● | <span style="font-size: 16px;"> **In-memory Computing using SONOS** (Non-Volatile Memory) <br> JEDEC Mobile/Client/AI Computing Forum <br> 🇹🇼 Hsinchu, Taiwan and 🇰🇷 Seoul, S. Korea , May 2023 </span> |
{:.about_table5}

---

|:-|
● | <span style="font-size: 16px;"> **Resilient Boot** (secure boot on processors without eNVM) <br> IEEE International Conference on Cyber Security and Resilience <br> 💻 Virtual, July 2021 </span> |
{:.about_table5}
